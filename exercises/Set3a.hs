...
capitalize str = capitalizeFirst (words str) (length str)

capitalizeFirst :: [String] -> Int -> String
capitalizeFirst str n
  | n >= 0 = capitalizeFirst ((toUpper . head $ str !! n ++ tail $ str !! n) ++ (take (n-1) str)) (n-1)
  | otherwise = ""
